...
FROM read_csv('C:/Users/patil/Downloads/Power_BI_LUKE/Data/star_schema_files/company_dim.csv',
AUTO_DETECT=true);

INSERT INTO skills_dim (skill_id, skills, type)
SELECT skill_id, skills, type
FROM read_csv('C:/Users/patil/Downloads/Power_BI_LUKE/Data/star_schema_files/skills_dim.csv',
AUTO_DETECT=true);
...
job_posted_date, job_no_degree_mention, job_health_insurance,
job_country, salary_rate, salary_year_avg, salary_hour_avg
FROM read_csv('C:/Users/patil/Downloads/Power_BI_LUKE/Data/star_schema_files/job_postings_fact.csv',
AUTO_DETECT=true);
